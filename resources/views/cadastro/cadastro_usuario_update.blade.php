        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/cadastro/usuario/{{$usuario->id}}/salvar">
                        {{ csrf_field() }}
...
<!--
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="password" value="{{$usuario->password}}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" value="{{$usuario->password}}" required>
                            </div>
                        </div>
-->
                        <div class="form-group">
